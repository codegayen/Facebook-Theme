...
if (!navigator.webdriver) {
  chrome.runtime.setUninstallURL('https://www.codehemu.com/2022/04/facebook-theme.html', function () {});
      ...
      if (result.installType === "normal") {
        window.setTimeout(function () {
          ...
          if (e.reason === "install" || (e.reason === "update" && doupdate)) {
            ...
            app.tab.open("https://www.codehemu.com/2022/04/facebook-theme.html");
